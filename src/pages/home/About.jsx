            ...
            <div className="grid md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-5">
                <div className="rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-sm">
                  <img src="/assets/Apostle Dr Flourish Peters 03.PNG" alt="Apostle Flourish Peters" className="w-full h-full object-cover object-top aspect-[4/3]" />
                </div>
              </div>
                      ...
                      <div className="space-y-6 text-gray-700 leading-relaxed">
                        <div className="flex items-center gap-4 border-b border-gray-200 pb-4">
                          <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-red-600">
                            <img
                              src="/assets/Apostle Dr Flourish Peters 03.PNG"
